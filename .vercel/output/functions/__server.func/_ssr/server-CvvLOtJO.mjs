...
import { n as getPglite, t as ensureDbReady } from "./db-4mSkQB1G.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/server-CvvLOtJO.js
...
function resolveGoogleProviderId() {
	return "grok-google";
}
function env$2(key) {
...
var googleDirect = Boolean(googleClientId && googleClientSecret);
...
var auth = betterAuth({
	...
	...googleDirect ? { socialProviders: { google: {
...
//#endregion
export { resolveGoogleProviderId as a, hasGateSessionMarker as i, authConfigured as n, gateIdentityEnabled as r, auth as t };
